...
const sourceProducts: SourceProduct[] = [
  ...
  { category: "Matizada", name: "Trend Cake", color: "15 colores", colorCount: 15, fiber: "100% Acrilico", weight: "200g", length: "360m", needles: "4-4.5-5", crochet: "4-4.5-5", kiloPrice: "", dozenPrice: "Venta por paquete (3 ovillos de 200g) · Mín. mayorista: 5 paquetes", colorsWithPhoto: "", allColors: "620, 621, 622, 623, 624, 625, 626, 627, 628, 629, 630, 631, 632, 633, 634", ...imagePresets.tanjaBatik, description: "Venta por paquete: cada paquete contiene 3 ovillos de 200g (total 600g por paquete). Venta mínima por mayor: 5 paquetes (colores a elección)." },
